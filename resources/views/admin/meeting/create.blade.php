...
@csrf
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" name="k_id" id="firstname" 
				   placeholder="请输入客户名字">
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" id="select_0" placeholder="请选择访问时间"/> 
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			<input type="text" class="form-control" name="m_desc" id="firstname" 
				   placeholder="请输入访问地址">
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-10">
		<input type="text" id="select_1" placeholder="请选择下次访问时间"/>
		</div>
	</div>
	<div class="form-group">
